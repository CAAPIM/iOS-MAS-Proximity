  ...
  withParameters:nil
    ...
    responseType:MASRequestResponseTypeJson
      ...
      completion:^(NSDictionary *responseInfo, NSError *error) {
          ...
          if (error)
          {
              NSError * pollError = [NSError errorForProximityErrorCode:MASProximityErrorCodeQRCodeAuthorizationPollingFailed info:error.userInfo errorDomain:MASProximityErrorDomainLocal];
              //
