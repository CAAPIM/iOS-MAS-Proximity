...
+ (void)authorizeAuthenticateUrl:(NSString *)authenticateUrl completion:(MASCompletionErrorBlock)completion
{
    ...
    // If url is empty
    //
    if (authenticateUrl == nil || [authenticateUrl length] == 0)
    {
        invalidURLError = [NSError errorForProximityErrorCode:MASProximityErrorCodeInvalidAuthenticationURL errorDomain:MASProximityErrorDomainLocal];;
    }
